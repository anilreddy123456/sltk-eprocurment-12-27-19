 ...
 */
@Entity
//@Table(name = "vendor", catalog = "sltkeproc", schema = "")
@Table(name = "vendor", catalog = "sltk_eprocurment", schema = "")
@NamedQueries({
...
public class Vendor implements Serializable {
    ...
    public Vendor(Integer vendorId, String password, short status) {
        this.vendorId = vendorId;
    ...
    public Integer getVendorSapCode() {
        return vendorSapCode;
    }

    public void setVendorSapCode(Integer vendorSapCode) {
    ...
    public String toString() {
        return "com.javatechie.spring.mysql.api.model.Vendor[ vendorId=" + vendorId + " ]";
    }
