 ...
 */
@Entity
//@Table(name = "countries", catalog = "sltkeproc", schema = "")
@Table(name = "countries", catalog = "sltk_eprocurment", schema = "")
...
public class Countries implements Serializable {
    ...
    public String toString() {
        return "com.javatechie.spring.mysql.api.model.Countries[ id=" + id + " ]";
    }
